...
CHECK_INTERVAL=${2:-60}
WEBHOOK_URL="https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=a7b7a4e6-79dc-4eb9-ae66-f94027f651f8"
...
send_notification() {
  curl -s "$WEBHOOK_URL" \
    ...
    -d '{
      "msgtype": "text",
      "text": {"content": "Process '$PID' (yelp) on AutoDL has completed."}
    }'
}
